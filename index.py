...
camera = "https://192.168.235.149:8080/video"
cap.open(camera)
  ...
  while True:
    ...
    for class_id,score,bbox in zip(class_ids,score,bboxes):
      ...
      if class_name=="person":
        i=i+1
        cv2.putText(frame, str(class_name) + str(i), (x-10, y-10),cv2.FONT_HERSHEY_SIMPLEX, 0.7,(0, 0, 255), 2)
        ...
        cv2.putText(frame, "PERSON : " + str(i), (30,60),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 2)
